...
uses
  ...
  QDialogs, QStdCtrls, QComCtrls, QExtCtrls, JvSimpleXml,
  db, JvMemoryDataset, Configuration, pluginlist;
...
procedure TButtonEventList.BuildEventList;
var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        EventList.Append;
        EventList.FieldByName('formname').AsString    := LowerCase(ButtonItem.Properties.Value('DRAWFORM'));
        ...
        EventList.FieldByName('buttoncaption').AsString := ButtonItem.Properties.Value('CAPTION');
        EventList.FieldByName('icon').AsString        := ButtonItem.Properties.Value('ICON');
        EventList.FieldByName('visible').AsBoolean    := ButtonItem.Properties.BoolValue('VISIBLE',True);
