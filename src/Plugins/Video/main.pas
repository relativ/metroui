...
uses
  ...
  ShellApi,IniFiles,
  AstechVideoWindow, Buttons, AppEvnts, StdCtrls;
...
type
  ...
  private
    PlayListTmp, VideoImgTmp, VolumeCloseImgTmp,VolumeOpenImgTmp: TPNGObject;
    BaseFolder: string;
...
begin
  ...
  PlayListTmp := TPNGObject.Create;
  VideoImgTmp := TPNGObject.Create;
  VolumeCloseImgTmp := TPNGObject.Create;
  VolumeOpenImgTmp  := TPNGObject.Create;
